...
def backtest_dca(
    ...
    for date, price in prices.items():
        ...
        if profit:
            ...
            remaining_days = max((prices.index[-1] - date).days, 1)
            profit_buy_amount = profit / remaining_days

            buy_amount = buy_amount + profit_buy_amount
            available_sum = available_sum + profit
